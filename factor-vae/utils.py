...
def parse_args():
    ...
    parser.add_argument(
        "--locale", type=str, default="hk", choices=["hk", "hu", "jp", "pl", "uk", "us"]
    )
    parser.add_argument("--len_hist", type=int, default=20)
    parser.add_argument("--num_stocks", type=int, default=1000)
    ...
    parser.add_argument("--metric", type=str, default="calc_rankicir")
